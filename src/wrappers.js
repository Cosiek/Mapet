...
(function() {
  var MapObjectWrapper, PolygonWrapper,
  ...
  PolygonWrapper = (function(superClass) {
    ...
    PolygonWrapper.prototype.markerOptions = {
      'icon': 'http://maps.google.com/mapfiles/ms/icons/blue-dot.png',
      'draggable': false,
      'clickable': false
    };

    PolygonWrapper.prototype.markerOptionsWhenSelected = {
      'icon': 'http://maps.google.com/mapfiles/ms/icons/red-dot.png',
      'draggable': true,
      'clickable': true
    };

    PolygonWrapper.prototype.helperMarkerOptions = {
    ...
    function PolygonWrapper(parent, options) {
      if (options == null) {
        options = {};
      }
      this.mainMarkers = [];
      this.markers = [];
      this.polygon = null;
      PolygonWrapper.__super__.constructor.call(this, parent, options);
    }

    PolygonWrapper.prototype.drawFromInitialData = function(data) {
    ...
    PolygonWrapper.prototype.getValue = function() {
    ...
    PolygonWrapper.prototype.isValid = function() {
    ...
    PolygonWrapper.prototype.clearHelperMarkers = function() {
    ...
    PolygonWrapper.prototype.crateMarker = function(position) {
      var marker, options;
    ...
    PolygonWrapper.prototype.createHelperMarker = function(position) {
      var marker, options;
    ...
    PolygonWrapper.prototype.clearMarker = function(marker) {
    ...
    PolygonWrapper.prototype.getMarkerOptions = function(options) {
      var optName, opts;
      if (options == null) {
        options = {};
      }
    ...
    PolygonWrapper.prototype.getHelperMarkerOptions = function(options) {
      var optName, opts;
      if (options == null) {
        options = {};
      }
    ...
    PolygonWrapper.prototype.updateMarkerOptions = function(marker, options) {
      var opts;
    ...
    PolygonWrapper.prototype.bindMarker = function(marker) {
    ...
    PolygonWrapper.prototype.rightclickMarker = function(this_, marker, ev) {
      if (marker.mainMarker) {
    ...
    PolygonWrapper.prototype.dragendMarker = function(this_, marker, ev) {
      if (!marker.mainMarker) {
        marker.mainMarker = true;
    ...
    PolygonWrapper.prototype.getHelperMarkerPosition = function(positionA, positionB) {
      var lat, lng;
    ...
    PolygonWrapper.prototype.refillMainMarkers = function() {
    ...
    PolygonWrapper.prototype.ensureWrapperCallbackExists = function(wrapperCallbackName) {
