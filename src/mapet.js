...
(function() {
  var MapHandler, MarkersMode, Mode, PolygonMode, PolylineMode, RouteMode, WrappersBaseMode,
    slice = [].slice,
  ...
  RouteMode = (function(superClass) {
    extend(RouteMode, superClass);

    function RouteMode() {
      this.useGoogleDirections = false;
      this.tmpUseGoogleDirections = false;
      this.directionsService = new google.maps.DirectionsService();
    }

    RouteMode.prototype.getNewWrapper = function(options) {
      if (options == null) {
        options = {};
      }
      return new RouteWrapper(this, options);
    };

    RouteMode.prototype.on_click = function(ev) {
      if (1) {
        this.tmpUseGoogleDirections = !this.useGoogleDirections;
      }
      RouteMode.__super__.on_click.call(this, ev);
      return this.tmpUseGoogleDirections = this.useGoogleDirections;
    };
